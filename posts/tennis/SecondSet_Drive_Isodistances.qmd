...
[New Zealand Road Network](MappingNZ_2023_11_06.png){fig-align="center" height="90%" width="90%"}
...
First things first, we need to set up our spatial data. We're going to need 3 different pieces of data: 1: The shape file for Auckland Central. This is will be our map layer, showing where Auckland is.
...
3: We need to transform our tennis club location data to be in the same format and CRS.
...
ggplot() +
  ...
  ggtitle("5km Driving Isodistances of Auckland Tennis Clubs")
